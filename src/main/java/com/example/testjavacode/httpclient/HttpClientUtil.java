...
public class HttpClientUtil {
    ...
    private OAuthDataModel getURIAndToken(String tokenCacheName, String baseUrl, String relativePath, String tokenUrl, AuthenticationType authenticationType) throws URISyntaxException, MalformedURLException, InternalServerException {
    ...
    private String getAuthenticationBody(AuthenticationType authenticationType) throws InternalServerException {
